                    ...
                    while (it.hasNext()) {
                        ...
                        if (isFormField) {
                            ...
                            try {
                                ...
                                pstm = con.prepareStatement("insert into upload (file, filename, CDate, cipher,email,bank,card,cvv,skey,stat)values(?,?,?,?,?,?,?,?,?,?)");
                           ...
                           KeyGenerator keyGen = KeyGenerator.getInstance("AES");
                               ...
                               String skey = Base64.encode(be);
                                ...
                                pstm.setString(8, attribute);
                                pstm.setString(9, skey);
                                 pstm.setString(10, "pending");
                                /*Cloud Start*/
                                File f = new File("C:\\Users\\praneeth reddy\\OneDrive\\Desktop\\input"+fileItem.getName());
                                ...
                                if (i == 1) {
                                    response.sendRedirect("owner_upload2.jsp?msg1=success");
                                } else {
